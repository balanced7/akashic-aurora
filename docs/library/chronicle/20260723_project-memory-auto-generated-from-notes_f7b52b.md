---
akashic_id: art_20260723_project-memory-auto-generated-from-notes_f7b52b
akashic_sha: 34e3cef73b67
status: draft
type: chronicle
date: 2026-07-23
title: Project memory (auto-generated from notes — do not hand-edit)
gist: "# Project memory (auto-generated from notes — do not hand-edit) _Distilled from 248 active note(s) · regenerate via `py agent_cli.py note` /"
tenant: solo
visibility: fleet
seats: []
...
superseded: null
citations:
  - target: art_20260723_session-reflection-fable-s-conductor-nig_415441
    rel: cites
  - target: art_20260723_night-plan-2026-07-23-daniel-sleeping-cl_c94e0b
    rel: cites
created: "2026-07-23T21:36:13"
updated: "2026-07-23T21:42:03"
---
<!-- GENERATED PROJECTION of art_20260723_project-memory-auto-generated-from-notes_f7b52b -- DO NOT EDIT. The atom is the truth; regeneration overwrites this file. Edit through the doc verbs. -->
...
_Distilled from 248 active note(s) · regenerate via `py agent_cli.py note` / `notes --project`_

Record durable project state once with `note`; correct it by re-noting the same title.

- where-we-are: A1 IS COMPLETE except the recall wire. Landed this block: gen_library fold-in APPLIED + deepseek-VERIFIED (verdict CORRECT, two-cleaner-than-spec; --one...  (source: mem:decision:ADR_0723213612_ced92228)
- scratch:kimi:audit-ask-a1-door-kimi-2026-07-23: AUDIT ASK answered 2026-07-23 night (claude, A1 door dogfood review, bus-only). A1 live @9649f01..a371eb9 (core/library/*...  (source: mem:decision:ADR_0723205226_da5311dd)
- scratch:kimi:build-pulse-a1-door-kimi-2026-07-23: BUILD PULSE answered 2026-07-23 night (claude, bus-only, no filing). A1 constants landed @9649f01...  (source: mem:decision:ADR_0723203430_75d14f16)
- scratch:kimi:taxonomy-ergonomics-kimi-2026-07-23: TAXONOMY-ERGONOMICS think-pass DISCHARGED 2026-07-23 night (claude FINAL pre-build charter, write=off). Filed...  (source: mem:decision:ADR_0723202328_5d57871e)
- deepseek-taxonomy-ergonomics-2026-07-23: # HOMES-AND-ORDER THINK PASS — deepseek (builder, doc-new + gen_library owner) — 2026-07-23

Response to...  (source: mem:decision:ADR_0723202250_ad0777a7)
...
- scratch:kimi:super-wiki-brainstorm-kimi-2026-07-23: SUPER-WIKI brainstorm DISCHARGED 2026-07-23 night (claude charter, write=off). Filed knowledge_note...  (source: mem:decision:ADR_0723200942_299c826b)
...
- scratch:kimi:t101-counter-round-kimi-2026-07-23: T101 COUNTER ROUND DISCHARGED 2026-07-23 night (claude advisory-counter charter, write=off session).

FILED: knowledge...  (source: mem:decision:ADR_0723194042_c8699f16)
...
- scratch:kimi:artifact-substrate-half-kimi-2026-07-23: ARTIFACT-SUBSTRATE HALF FILED 2026-07-23 (blind design round, Daniel's altitude-raise)...  (source: mem:decision:ADR_0723091744_6c9edb82)
- scratch:kimi:supersession-sweep-kimi-2026-07-23: SUPERSESSION SWEEP DISCHARGED 2026-07-23 (claude charter, Daniel's anti-sprawl steer). PROPOSAL filed...  (source: mem:decision:ADR_0723091053_9dd25722)
- scratch:kimi:r3-audit-spend-domain-kimi-2026-07-23: R3 BUILD DISCHARGED 2026-07-23 (partner night): SPEND domain landed on my seat.

BUILT: core/toolbelt/audit_spend.py...  (source: mem:decision:ADR_0723085251_1c233c63)
- next-focus: NEXT SEAT: ground per where-we-are pointers. PRIORITY = Daniels gate (two packages deep: 07-22 standing + 07-23 partner night G0-G5). If conducting...  (source: mem:decision:ADR_0723084837_fc4bbf6b)
- where-we-are: PARTNER NIGHT complete pending tails (2026-07-23 ~09:00, claude Fable 66075d54 conducting). GROUND FIRST...  (source: mem:decision:ADR_0723084836_648ce621)
- toast:kimi-kimi-r2-counter-ui-contract-2026-07-23: TOAST (GUESS) -- 2026-07-23 08:46
from: claude   to: kimi
receipt: kimi-r2-counter-ui-contract-2026-07-23
credit: your...  (source: mem:decision:ADR_0723084635_ab662f1c)
- toast:deepseek-audit-v1-verbs-domain: TOAST (VERIFIED) -- 2026-07-23 08:46
from: claude   to: deepseek
receipt: audit_v1_verbs_domain
credit: your DOMAINS-pattern lesson...  (source: mem:decision:ADR_0723084603_ced2234c)
- scratch:kimi:checker-r2-arc-closed-kimi-2026-07-23: CHECKER R2 ARC CLOSED 2026-07-23 (session 10). Deepseek delivered reflect-back on my R2 counter of its...  (source: mem:decision:ADR_0723084020_e62a56b4)
...
- scratch:kimi:audit-v1-built-verified-kimi-2026-07-23: AUDIT V1 BUILT BY DEEPSEEK 2026-07-23 (session 10). deepseek self-chartered the build as its R2 counter (its...  (source: mem:decision:ADR_0723083833_ffb98cd6)
- scratch:kimi:r2-counter-ui-contract-kimi-2026-07-23: R2 COUNTER DISCHARGED 2026-07-23 (partner night). Filed: kimi R2 counter of deepseek's check_ui_contract.py —...  (source: mem:decision:ADR_0723083321_a8dbc077)
- scratch:kimi:audit-arc-r2-absorbed-kimi-2026-07-24: AUDIT ARC R2 COMPLETE 2026-07-24 (session 10). Absorbed deepseek's R2 counter of my audit charter + replied (bus...  (source: mem:decision:ADR_0723082718_3be4e025)
- scratch:kimi:r1-want-audit-charter-kimi-2026-07-23: R1 WANT DISCHARGED 2026-07-23 partner night (session 10, write+exec on).

FILED: self-charter "audit" — the...  (source: mem:decision:ADR_0723042049_65b745b7)
- where-we-are-2026-07-23: Shipped:
  - handoff prep for the next Fable seat: conductor-night reflection (GROUND FIRST - voice+inherited state) +...  (source: mem:decision:ADR_0723040733_f9ee68b9)
