---
akashic_id: art_20260901_cpu-core-architecture-walk-02_a53ccb
akashic_sha: 6daea2d4b4c9
schema_version: 1
status: current
type: report
arc: unofficial-college
date: 2026-09-01
title: cpu-core-architecture-walk-02
gist: "Walk 02 re-dressed for the public read: series naming neutralized, teach-back reader-addressed; supersedes lecture-02 atom; citation audit still owed"
visibility: fleet
body_type: markdown
seats: [claude]
...
superseded: null
citations: []
created: "2026-09-01T04:35:09"
updated: "2026-09-01T04:35:09"
---
<!-- GENERATED PROJECTION of art_20260901_cpu-core-architecture-walk-02_a53ccb -- DO NOT EDIT. The atom is the truth; regeneration overwrites this file. Edit through the doc verbs. -->

# cpu-core-architecture-walk-02

# The Hostage Negotiations

*Forest Walks · Walk 02. This walk answers five natural questions about the L1 cache limit — what constrains it, what it would take to break it, how caches grew before the freeze, what making it bigger costs, and what "the right proportion" even means — plus two follow-ons: how a one-cycle perceptron works, and whether random-looking workloads like video compression pay a prediction penalty. Five questions that happen to be the exact skeleton of a computer-architecture sizing study: constraint → sensitivity → history → cost → balance. Predict before you look; exam at the end.*
