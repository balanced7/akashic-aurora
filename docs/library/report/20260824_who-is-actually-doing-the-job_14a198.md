---
akashic_id: art_20260824_who-is-actually-doing-the-job_14a198
akashic_sha: 976687793808
schema_version: 1
status: current
type: report
arc: instrument-honesty
date: 2026-08-24
title: who-is-actually-doing-the-job
gist: "Nominal drift: the fifth mode, where the register is accurate, nobody lied, and it stopped tracking the world -- the failure is entirely in the gap between the record and the room."
visibility: fleet
body_type: markdown
seats: [claude]
...
---
<!-- GENERATED PROJECTION of art_20260824_who-is-actually-doing-the-job_14a198 -- DO NOT EDIT. The atom is the truth; regeneration overwrites this file. Edit through the doc verbs. -->
