...
| Heal no longer clobbers a live list | LAW B named site | **SHIPPED** | none (7de1a62) | `store.py:999-1004` backfill-only; pinned against a real redis:7 service in `.github/workflows/ci.yml` |
