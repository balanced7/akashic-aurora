---
akashic_id: art_20260804_security-design_31817c
akashic_sha: e240553468e2
schema_version: 1
status: current
type: design
date: 2026-08-04
title: security-design
gist: "--- title: The security plane of the wire journal — outbound DLP, body capture, and the fleet egress monitor task: T156 WIRE-B (dimension: s"
visibility: fleet
body_type: markdown
seats: []
category: [agent-lifecycle, security, narrative]
origin: authored
settled: settled
supersedes: null
superseded: null
...
---
<!-- GENERATED PROJECTION of art_20260804_security-design_31817c -- DO NOT EDIT. The atom is the truth; regeneration overwrites this file. Edit through the doc verbs. -->
