---
akashic_id: art_20260709_aurora-glass-synthesis-plan-claude-deeps_af1a8f
akashic_sha: a2c44d4e658c
status: current
type: design
date: 2026-07-09
title: Aurora Glass — Synthesis Plan (claude ⋈ deepseek)
gist: "_Merge of two independently-developed plans, 2026-07-04. Inputs: [ui-plan-claude.md](ui-plan-claude.md) + [ui-moodboard-claude.md](ui-moodbo"
tenant: solo
visibility: fleet
seats: []
category: [ui]
...
---
<!-- GENERATED PROJECTION of art_20260709_aurora-glass-synthesis-plan-claude-deeps_af1a8f -- DO NOT EDIT. The atom is the truth; regeneration overwrites this file. Edit through the doc verbs. -->
