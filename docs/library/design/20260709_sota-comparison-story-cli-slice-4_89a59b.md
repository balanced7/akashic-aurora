---
akashic_id: art_20260709_sota-comparison-story-cli-slice-4_89a59b
akashic_sha: 02579ec28f56
status: fossil
type: design
date: 2026-07-09
title: "SOTA Comparison: `story` CLI (Slice 4)"
gist: "## Comparable Tools | Tool | What it does | Overlap with `story` | Gaps vs `story` | |---|---|---|---| | **git CLI** (`git log`, `git show`,"
tenant: solo
visibility: fleet
seats: []
category: [memory, security, tooling]
origin: migrated
settled: settled
supersedes: null
superseded: null
...
---
<!-- GENERATED PROJECTION of art_20260709_sota-comparison-story-cli-slice-4_89a59b -- DO NOT EDIT. The atom is the truth; regeneration overwrites this file. Edit through the doc verbs. -->
