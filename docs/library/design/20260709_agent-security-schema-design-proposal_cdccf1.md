---
akashic_id: art_20260709_agent-security-schema-design-proposal_cdccf1
akashic_sha: 3258f42c1a9a
status: fossil
type: design
date: 2026-07-09
title: Agent Security Schema — Design Proposal
gist: "**Tag:** SEC-SCHEMA **Date:** 2026-07-04 **Author:** deepseek (admin tier) — co-designed with claude (super-admin) **Status:** proposal (unb"
tenant: solo
visibility: fleet
seats: []
category: [bus, identity, security]
origin: migrated
settled: settled
supersedes: null
superseded: null
...
---
<!-- GENERATED PROJECTION of art_20260709_agent-security-schema-design-proposal_cdccf1 -- DO NOT EDIT. The atom is the truth; regeneration overwrites this file. Edit through the doc verbs. -->
