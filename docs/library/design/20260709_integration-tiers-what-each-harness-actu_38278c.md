---
akashic_id: art_20260709_integration-tiers-what-each-harness-actu_38278c
akashic_sha: e8dfbbd1ddcb
status: current
type: design
date: 2026-07-09
title: Integration tiers — what each harness actually delivers
gist: "> Arc started 2026-07-02 (renamed from \"citizenship\"). Live matrix: **`py agent_cli.py > harnesses`** (data: `agent/harness/registry.py` — t"
tenant: solo
visibility: fleet
seats: []
category: []
...
---
<!-- GENERATED PROJECTION of art_20260709_integration-tiers-what-each-harness-actu_38278c -- DO NOT EDIT. The atom is the truth; regeneration overwrites this file. Edit through the doc verbs. -->
