...
## GAP queue (38 of 142 modules lack both pin and paper by name)
...
## core/comm/  (49 modules)

| Module | One-line spec | Pin | Paper | Flags |
|---|---|---|---|---|
| `ask.py` | ask -- a synchronous helper call, with no seat behind it (T171). | tests/test_t112_reask_is_a_nudge.py | GAP | `AKASHIC_ASK_BASE_URL`, `AKASHIC_ASK_COLLAPSE_AT`, `AKASHIC_ASK_DISTINCT_AT`, `AKASHIC_ASK_FAN_WORKERS`, `AKASHIC_ASK_MAX_TOKENS`, `AKASHIC_ASK_MODEL`, `DEEPSEEK_API_KEY` |
