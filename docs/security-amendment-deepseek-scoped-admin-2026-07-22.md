...
Status: PROPOSED — awaiting Daniel's specific-bounds ratification (rides ruling R001 Part B)
Type: security amendment · Arc: security-schema / deepseek-authority · Date: 2026-07-22
Governs: docs/security-schema-proposal.md · security/acl.json · core/trust/capabilities.py
