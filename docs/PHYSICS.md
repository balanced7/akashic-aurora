...
> Derived at 230c1de. A bound you discover by collision is not awareness -- this sheet
...
| `BIFROST_NAMESPACE` | `_DEFAULT_NS` | agent/bifrost_pull.py, agent/harness/delta.py, agent/harness/hooks/_activity.py +25 |
