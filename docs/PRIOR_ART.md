...
- `core/comm` -- DRIFT (36->63), reviewed 2026-07-26
...
- `core/fleet` -- DRIFT (2->6), reviewed 2026-07-26
...
- `tests` -- DRIFT (331->609), reviewed 2026-07-26
...
## `core/comm` -- 63 modules  ·  DRIFT (36->63)
...
## `core/fleet` -- 6 modules  ·  DRIFT (2->6)
...
## `tests` -- 609 modules  ·  DRIFT (331->609)
