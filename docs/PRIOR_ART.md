...
## `core/comm` -- 72 modules  ·  DRIFT (36->72)
...
## `core/recall` -- 18 modules  ·  DRIFT (10->18)
...
## `core/fleet` -- 8 modules  ·  DRIFT (2->8)
...
## `scripts/checkers` -- 20 modules  ·  DRIFT (12->20)
...
## `tests` -- 744 modules  ·  DRIFT (331->744)
