...
- `core/comm` -- DRIFT (36->53), reviewed 2026-07-26
- `core/coord` -- DRIFT (11->18), reviewed 2026-07-26
...
- `scripts/ops` -- DRIFT (2->4), reviewed 2026-07-26
- `tests` -- DRIFT (331->532), reviewed 2026-07-26
...
## `core/comm` -- 53 modules  ·  DRIFT (36->53)
...
## `core/coord` -- 18 modules  ·  DRIFT (11->18)
...
## `scripts/ops` -- 4 modules  ·  DRIFT (2->4)
...
## `tests` -- 532 modules  ·  DRIFT (331->532)
