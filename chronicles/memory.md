...
- where-we-are: Shipped:
  - T031 hook 1 SHIPPED -- the RECONCILIATION GATE (deepseek's design, the method baseline's lead forcing function): substrate ships now cite...  (source: mem:decision:ADR_0711010836_9626)
