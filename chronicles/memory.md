...
- where-we-are: Shipped:
  - METHOD BASELINE codified (Daniel-directed: excellence repeatable + empirical, the new match-or-exceed bar) -- built BY the method it codifies...  (source: mem:decision:ADR_0711004425_8800)
