...
| Config flags | **No map at all** | T034's diagnosis stands: AKASHIC_*/DEEPSEEK_* across 8+ files + module constants + Redis control keys; we ADDED BIFROST_STALE_MS today with nowhere to register it |
