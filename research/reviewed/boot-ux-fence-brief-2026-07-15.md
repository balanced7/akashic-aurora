...
Status: current (2026-07-15). Brief only — protocol by reference (method-baseline + T049). This is the shared input for a two-half fence; it is not itself a finding.
