...
Status: current — awaiting Daniel gate (touches reachability + shares ManagedChild with the remote-steering op_daemon)
Type: reconciliation (co-design, both halves + deepseek concurrence) · Arc: fleet / seat-lifecycle (night-friction P1, W62) · Seats: deepseek (runner half) + claude (seat/hook half), both concurred · Date: 2026-07-22
