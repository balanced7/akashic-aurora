...
Status: current (Daniel-ordered compilation; the comparison + gate frame at the end)
Type: report (corpus compilation) · Arc: interface / optics · Seats: claude (compiler,
sighted auditor) · Date: 2026-07-23
