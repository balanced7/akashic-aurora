...
// palindrome-axis-fail -- 2026-08-07, for Daniil's assessment detour.
//
...
const int  n     = 4;                        // "shoe" -- EVEN, and not a palindrome
...
int radar(int i){
  if(i==0) return 18; if(i==1) return  7;
  if(i==2) return 14; if(i==3) return  4;
  return -1;
}
