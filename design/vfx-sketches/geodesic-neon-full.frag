...
vec3 spectrum(float n) {
    float k = cos(6.28318 * n) * .5 + .5;
    return mix(vec3(0.10, 0.65, 1.0), vec3(0.55, 1.0, 1.0), k);
}
...
const vec3 FACE_COLOR = vec3(.62,.76,.98);
const vec3 BACK_COLOR = vec3(.04,.07,.14);
