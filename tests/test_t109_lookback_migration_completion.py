...
pre-registered, NEVER TUNED) has been RED since 425cf52 removed 621 docs/*.md originals
...
battery -- the lease's hard boundary):
  ...
  P2  a migrated doc's ORIGINAL slug resolves to its atom -- the handle, not just the
      bytes (content reachable as bytes, unreachable as a handle = the T113/425cf52
...
# original was deleted in 425cf52). Chosen for distinctive vocabulary with no surviving
